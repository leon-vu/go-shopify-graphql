...
type ProductService interface {
	List(query string) ([]models.Product, error)
	ListAll() ([]models.Product, error)

	Get(id string) (*models.Product, error)

	Create(product models.ProductInput) (*string, error)

	Update(product models.ProductInput) error

	Delete(product models.ProductDeleteInput) error

	VariantsBulkCreate(id string, input []models.ProductVariantsBulkInput) error
	VariantsBulkUpdate(id string, input []models.ProductVariantsBulkInput) error
	VariantsBulkReorder(id string, input []models.ProductVariantPositionInput) error
}
...
func (s *ProductServiceOp) ListAll() ([]models.Product, error) {
	q := fmt.Sprintf(`
		{
			products{
				edges{
...
func (s *ProductServiceOp) List(query string) ([]models.Product, error) {
	q := fmt.Sprintf(`
		{
...
func (s *ProductServiceOp) Get(id string) (*models.Product, error) {
...
func (s *ProductServiceOp) getPage(id string, cursor string) (*models.Product, error) {
	q := fmt.Sprintf(`s
...
func (s *ProductServiceOp) Create(product models.ProductInput) (*string, error) {
...
func (s *ProductServiceOp) Update(product models.ProductInput) error {
...
func (s *ProductServiceOp) Delete(product models.ProductDeleteInput) error {
...
func (s *ProductServiceOp) VariantsBulkCreate(id string, input []models.ProductVariantsBulkInput) error {
...
func (s *ProductServiceOp) VariantsBulkUpdate(id string, input []models.ProductVariantsBulkInput) error {
...
func (s *ProductServiceOp) VariantsBulkReorder(id string, input []models.ProductVariantPositionInput) error {
